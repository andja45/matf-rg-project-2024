...
class EventChain {
    ...
    static constexpr float NIGHT_DURATION = 15.0f;
    static constexpr float CORE_EMERGING_DURATION = 5.0f;
    static constexpr float DEFAULT_INTENSITY = 1.0f;
    static constexpr float DIRECTIONAL_LIGHT_DIM_INTENSITY = 0.4f;
    static constexpr float POINT_LIGHT_GLOW_INTENSITY = 2.0f;
    static constexpr float PULSE_SPEED = 2.0f;
    static constexpr float PULSE_AMPLITUDE = 1.1f;
    static constexpr float POINT_LIGHT_LOW_Y = -0.362f;
    static constexpr float POINT_LIGHT_HIGH_Y = 0.265f;
    static constexpr float POINT_LIGHT_BOB_AMPLITUDE = 0.0f;
    static constexpr float POINT_LIGHT_BOB_SPEED = 3.0f;
    ...
    static constexpr float SKYBOX_MAX_DARKNESS = 0.7f;
