...
void Scene::initialize() {
    ...
    SceneObject crystal("fantasy_crystals", glm::vec3(0.0f, 1.0f, 0.0f), glm::vec3(1.0f));
    glm::vec3 core_position = crystal.position();
    add_object(std::move(crystal));

    auto point_light = std::make_unique<engine::graphics::PointLight>(
            core_position, 1.0f, 0.09f, 0.032f, glm::vec3(0.05f), glm::vec3(1.0f, 0.5f, 0.2f), glm::vec3(1.0f));
