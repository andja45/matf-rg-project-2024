...
public:
    ...
    /**
            * @brief Activates `unit` and binds `texture_id` to it as a cubemap texture.
            * @param unit texture unit index to activate before binding.
            * @param texture_id OpenGL id of the cubemap texture to bind.
            */
    ...
    /**
            * @brief Binds fbo as the current framebuffer.
            * @param fbo Framebuffer id to bind.
            */
    static void bind_framebuffer(uint32_t fbo);

    /**
            * @brief Draws a fullscreen quad, used by full-screen passes
            */
    static void render_fullscreen_quad();
